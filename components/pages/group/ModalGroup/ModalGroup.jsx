...
const ModalGroup = () => {
  ...
  return (
    <Modal title={!editGroup ? 'Добавить группу' : `Редактировать группу "${editGroup?.S_CATEGORY_GROUP_NAME}"`} onClose={() => dispatch(setShowModalGroup(false))} show={modalGroup} className={styles.modal}>
